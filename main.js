...
const counting = { 
  ...
  value: function (n) {
   this.count = n !== undefined ? n : this.count
    return this.count;
  },
...
//   return {
//     value: function (n) {
//       n !== undefined ? this.count = n : this.count
//       return this.count;
//     },
...
//# 2 способ
// const createCar = (engineArg, modelArg, nameArg, yearArg, usedArg) => ({
//   engine: engineArg,
//   model: modelArg,
//   name: nameArg,
//   year: yearArg,
...
// const car = createCar(2000, 'Lacetti', 'Chevrolet', 2010, 'used');
// const car2 = createCar(5000,'FX50','Infinite', 2019, 'new');
...
console.log(myDouble(5)); // = myMul(2, 3) = 6
